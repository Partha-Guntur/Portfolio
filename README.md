...
**Machine Learning Engineer @ Quixy (_March 2025 – July 2025_)**
- Banas Diary Procurement Data Analysis and Building Automated Dashboard, During my internship at Vividminds, I developed and optimized machine learning models that automated data analysis and forecasting for business clients.
- I worked extensively on agentic AI systems integrating Large Language Models (LLMs) to perform autonomous data cleaning, exploratory
analysis, and report generation.
One major outcome was building a forecasting tool for Banas Dairy to predict milk procurement volumes, improving accuracy and decision
efficiency.
The experience enhanced my skills in applied AI, data handling, and business problem-solving while teaching me to manage complex
datasets, collaborate in team environments, and deliver solutions under tight project deadlines.
